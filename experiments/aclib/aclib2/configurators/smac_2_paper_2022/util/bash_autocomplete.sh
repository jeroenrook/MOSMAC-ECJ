...
_smac()
{
	...
	--init-mode|--initialization-mode)
		answers="CLASSIC  ITERATIVE_CAPPING  UNBIASED_TABLE  DOUBLE_RACING"
		COMPREPLY=( $(compgen -W "${answers}" -- ${cur}) )
 		return 0
		;;
	--fork-to-tae-policy)
