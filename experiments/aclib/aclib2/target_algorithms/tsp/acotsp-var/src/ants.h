...
extern double q0;            /* probability of best choice in tour construction */
...
#define DEFINE_INTEGER_PARAMETER(PARAM)                                        \
    extern long int PARAM;
#define DEFINE_OPTIONS_PARAMETER(PARAM, B, C, D, TYPE)                         \
    extern enum enum_##TYPE option_##PARAM;
#define DEFINE_PARAMETER(PARAM,B,C,D, TYPE) TYPE(PARAM)
#define DEFINE_OPTION(E,S) E
#define DEFINE_OPTIONS(NAME, ...)                                              \
    enum enum_##NAME { __VA_ARGS__ };
#include "acotsp-parameters.def"
extern long int max_n_ants;
extern long int opt_n_ants;
extern double opt_beta;
extern double opt_rho;
extern double opt_q0;
